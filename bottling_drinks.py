""".
вкусовая добавка может быть только одна на бутылку газировки.
вкусовые добавки можно использовать в любой последовательности.
Выпускать напиток без добавки можно лишь в том случае если все вкусовые добавки закончились
"""
import itertools
